export default function Page(){
    return(
        <div className="flex justify-center items-center w-full rounded-sm py-12">
            <div className="border border-gray-300 shadow-sm hover:shadow-md rounded-sm">
                <h4 className="px-60 py-4 bg-gradient-to-bl font-bold from-gray-700 to-stone-900 text-white">Add A User</h4>
  ...
  <option value="" disabled selected>Select a Role</option>
    <option value="2024-25">Super Admin</option>
    <option value="t-28">Admin</option>
    <option value="t-27">Program Director</option>
    <option value="t-27">Examnination</option>
    <option value="t-27">Accounts</option>
    <option value="t-27">Reports</option>
  </select>
