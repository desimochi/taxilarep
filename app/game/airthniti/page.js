...
export default function HtmlPage() {
  ...
  return (
    <div className="w-full h-screen bg-gray-900 py-8">
        <h1 className="text-center text-white font-bold text-4xl mb-4">ARTHNITI</h1>
     <div className="max-w-7xl mx-auto flex justify-between mb-3">
            <Link href="/game/airthniti/how-to-play" className="bg-yellow-100 text-yellow-700 px-4 py-1 rounded-sm flex items-center gap-1"><HelpCircle /> Instructions</Link>
