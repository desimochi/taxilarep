  ...
  return (
    <div className="w-full h-screen bg-gray-50 py-12 mb-12">
     ...
     <div className="max-w-7xl mx-auto flex justify-between mb-5">
            <Link href="/game/titan/how-to-play" className="bg-yellow-100 text-yellow-700 px-4 py-1 rounded-sm flex items-center gap-1"><HelpCircle /> Game Instructions</Link>
            <Link href="/game/titan/learning-outcome" className="bg-red-100 text-red-700 px-4 py-1 rounded-sm flex items-center gap-1"><BookAIcon /> Learning Outcomes</Link>
