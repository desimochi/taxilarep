  ...
  return (
    <div className="w-full h-screen py-8">
     <div class="max-w-7xl mx-auto flex justify-between mb-3">
            <Link href="/game/stratsim/leaderboard" class="bg-green-100 text-green-700 px-4 py-1 rounded-sm flex items-center gap-1"> <Award /> See LeaderBoard</Link>
        </div>
      <iframe
        src={`/strastim.html?userId=${encodedState}&name=${encodedStateName}`}
