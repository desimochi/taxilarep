  ...
  return (
    <div className="w-full h-screen bg-gray-900 py-8">
     ...
     <div className="max-w-7xl mx-auto flex justify-between mb-3">
            <Link href="/game/airthniti/how-to-play" className="bg-yellow-100 text-yellow-700 px-4 py-1 rounded-sm flex items-center gap-1"><HelpCircle /> Game Instructions</Link>
      ...
      <iframe
        src={`/pm.html?userId=${encodedState}&name=${encodedStateName}`}
