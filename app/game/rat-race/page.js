  ...
  return (
    <div className="w-full h-screen bg-black py-8">
     <div class="max-w-7xl mx-auto flex justify-between mb-3">
            <Link href="/game/rat-race/how-to-play" class="bg-yellow-100 text-yellow-700 px-4 py-1 rounded-sm flex items-center gap-1"><HelpCircle /> Game Instructions</Link>
