...
import { PlusSquareIcon, Trash } from "lucide-react";
...
export default function Page(){
    ...
    return(
        ...
        <div className="border border-gray-300 rounded-xl mt-4 bg-gradient-to-bl from-gray-600 to-stone-900 text-white p-2 hover:shadow-xl transition-shadow  py-8 px-12">
            <div className="flex justify-between items-center gap-2">
                <div className="w-3/5">
            <h5 className="text-2xl font-bold flex"><PaperClipIcon className="h-7 w-7"/> Notice Board</h5>
            <span className="text-sm text-gray-400">Taxila Business School</span>
            </div>
            <div className="w-1/5">
                <input type="text" name="search" placeholder="search a notice.." className="bg-white border border-gray-300 text-gray-700 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
            </div>
            <div className="w-1/5">
            <button onClick={toggleModal} className="flex gap-1 justify-center w-full bg-black py-2.5 rounded-sm"><PlusSquareIcon className="h-5 w-5" />Post a Notice</button>
            </div>
            </div>
    ...
    <thead className="text-xs text-white uppercase bg-black dark:bg-gray-700 dark:text-white-400 w-full">
        <tr>
            ...
            <th scope="col" className="px-6 py-3">Vaild Till</th>
            <th scope="col" className="px-6 py-3">Action</th>
        </tr>
    </thead>
    <tbody className="w-full">
        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
        <td className="px-6 py-4 w-40">14/02/2025</td>
            <td className="px-6 py-4 w-40">Exam Schedule Out</td>
            <td className="px-6 py-4 w-40">
               Check out the exam schedule at - <span className="text-blue-500">Open in Drive</span>
            </td>
            <td className="px-6 py-4 w-40">
                <div className="flex items-center">Examination Department</div>
            </td>
            <td className="px-6 py-4 w-40">
            ...
            <td className="px-6 py-4 w-40">
                <Trash className="w-5 h-5" onClick={()=>setIsDel(true)} />
            </td>
        </tr>
    </tbody>
</table>
