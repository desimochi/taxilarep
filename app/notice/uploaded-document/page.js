    ...
    return (
        ...
        <thead className="text-xs text-white uppercase bg-black dark:bg-gray-700 dark:text-white-400 w-full">
            <tr>
                ...
                <th scope="col" className="px-6 py-3">File Title</th>
                <th scope="col" className="px-6 py-3">Action</th>
            </tr>
        </thead>
        <tbody className="w-full">
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
            <td className="px-6 py-4 w-40">T-29</td>
                <td className="px-6 py-4 w-40">Term-5</td>
                <td className="px-6 py-4 w-40">
                    PGDM Handbook 2025-27
                </td>
                <td className="px-6 py-4 w-40">
                    <div className="flex items-center gap-2 text-white">
                        <span className="py-2 px-2.5 rounded bg-red-600 hover:bg-red-700"><DownloadIcon className="w-5 h-5" /></span>
                        <span className="py-2 px-2.5 rounded bg-gray-800 hover:bg-gray-950" onClick={()=>setIsDel(true)}><TrashIcon className="w-5 h-5" /></span>
                    </div>
                </td>
