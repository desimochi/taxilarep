...
export default function ClassOverview() {
  ...
  return (
    <section className="relative">
        ...
        <h1 className="text-3xl font-bold mb-2 font-sans">Notes Details </h1>
            <p className="text-sm text-gray-500 mb-8">Everyhting you need to know about Your Notes</p>
              ...
              {sclass.map((product, index) => (
                <tr key={index} className="border-b text-sm">
                  ...
                  <Link
                    ...
                    <Link
                      href={`/notes/see-notes/${product.id}`}
