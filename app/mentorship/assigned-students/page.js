"use client"
import { Trash2Icon, UsersRound } from "lucide-react";
    ...
    return (
        <div className="px-5 py-4">
            <div className="border border-gray-300 rounded-xl mt-4 bg-gradient-to-bl from-gray-700 to-stone-900 text-white p-2 hover:shadow-xl transition-shadow  py-8 px-12">
                <div className="flex justify-between items-center gap-2">
                    <div className="w-3/5">
                <h5 className="text-2xl font-bold flex gap-1"><UsersRound className="w-7 h-7"/> Mentorship - Assigned Student</h5>
        ...
        <thead className="text-xs text-white uppercase bg-black dark:bg-gray-700 dark:text-white-400 w-full">
            <tr>
                ...
                <th scope="col" className="px-6 py-3">Assigned Students</th>
            </tr>
        </thead>
        <tbody className="w-full">
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
          
                <td className="px-6 py-4 border-r-2">Prof. Lavina Khilani</td>
                <td className="px-6 py-4">
                    <ul className="list-disc">
                        <li className="flex justify-between list-disc">
                            <p>Mr. Rajat Singh</p>
                            <Trash2Icon className="w-5 h-5" onClick={()=>setIsDel(true)}/>
                        </li>
            ...
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td className="px-6 py-4 border-r-2">Prof. Sanjoli Jain</td>
                <td className="px-6 py-4">
                    <ul className="list-disc">
                        <li className="flex justify-between list-disc">
                            <p>Ms. Sweta Yadav</p>
