    ...
    <div className="bg-white min-h-screen">
        <section className="relative">
           ...
           <div className="w-full pt-4 relative z-10 backdrop-blur-3xl">
            ...
            <ResueForm heading="See Student Fee Information" batch={batch} term={term} course={course} showterm={false} enrollement={true} api="/fees-management" redirect="" type={false}/>
          </div>
        </div>
        </section>
        </div>
