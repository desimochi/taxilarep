    ...
    return (
        ...
        <section className="relative">
           ...
           <div className="w-full pt-4 relative z-10 backdrop-blur-3xl">
            ...
            <ResueForm heading="Add Result Announcement" batch={batch} term={term} course={course} showterm={true} date={true} enrollement={false} api="student-result-save" redirect="/confirm-result-announcement"type={true} method="POST"/>
          </div>
        </div>
        </section>
        </div>
