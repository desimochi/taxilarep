...
<div>
<p><span class="font-semibold">Name:</span> {admitcard.student_name}</p>
<p><span class="font-semibold">Fathers Name:</span> {admitcard.student_father_name}</p>
<p><span class="font-semibold">Course:</span> {admitcard.student_course}</p>
</div>
<div>
<p><span class="font-semibold">Enrollment No:</span> {admitcard.student_enrollment_number}</p>
<p><span class="font-semibold">Term:</span> {admitcard.student_term}</p>
<div class="mt-2">
...
<tbody>
{admitcard.subject_data?.map((subject, index) => {
