  ...
  return (
    <div className="min-h-screen bg-slate-50 px-4 sm:px-10 py-6">
      ...
      {students && (
        <>
          {/* ================= HERO ================= */}
          <div className="rounded-2xl bg-gradient-to-r from-red-700 to-red-900 text-white p-6 sm:p-8 shadow-lg mx-12 mt-8">
          ...
          {/* ================= MAIN GRID ================= */}
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mt-8 mx-12">
              ...
              <div className="bg-white rounded-xl shadow-sm border p-5">
                ...
                {additionalData.map(comp => (
                  ...
                  >
                    ...
                    {comp.name === "Report" ? (
                      <Link
                        href={`/student/internship/details?compId=${comp.id}?subId=${students.id}`}
