  ...
  const handleTermChange = (e) => {
    ...
    return(
        ...
        <tr key={subject.subjectMappingId} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            ...
            <td className="px-6 py-4 flex gap-2"><Link href={`/student/subject/details/${subject.subjectMappingId}`} className="flex gap-2 text-red-500"><EyeIcon className="h-5 w-5"/>See Details</Link></td>
        </tr>
    ))}
                                    </tbody>
                                </table>
