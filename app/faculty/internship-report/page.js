        ...
        <div className="px-6 py-8">
            <div className="border border-gray-300 rounded-xl mt-4 bg-gradient-to-bl from-gray-700 to-stone-900 text-white py-8">
                <div className="flex justify-between items-center px-6">
                    <div className="w-2/5">
                        <h5 className="text-xl font-bold">Internship Report</h5>
                        <p className="text-sm">Assigned student </p>
                    </div>
                        ...
                        filteredMentees.map((stu, index) => (
                            <tr key={stu.id} className="bg-white border-b hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4">
                                   <Link href={`/students/internship/details/${stu.id}`} ><button className="bg-blue-500 text-white px-3 py-1 rounded">
                                        Details
                                    </button> </Link>
                                </td>
                            </tr>
