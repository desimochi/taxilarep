      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {subjects.map((item) => (
          ...
          >
            ...
            {/* Footer */}
            <Link href={`/internship/mentor/subject/${item.id}`} className="mt-6 inline-block w-full text-center rounded-xl bg-gradient-to-r from-red-600 to-red-700 text-white py-2.5 font-medium hover:from-red-700 hover:to-red-600 transition">
            See Details
            </Link>
          </div>
        ))}
