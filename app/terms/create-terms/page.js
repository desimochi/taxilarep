...
export default function Page(){
    ...
    return(
        <div className="flex justify-center items-center max-w-3xl mx-auto rounded-sm py-12">
            <div className="border border-gray-300 shadow-sm hover:shadow-md rounded-sm w-80">
                <h4 className="text-center py-4 bg-gradient-to-bl font-bold from-gray-700 to-stone-900 text-white">Create a Term</h4>
